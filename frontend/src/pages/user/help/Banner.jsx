...
const Banner = ({ image, title, subtitle }) => {
  return (
    <div className="w-screen relative center bg-[length:100%_100%] h-[35vh] md:h-[45vh] lg:h-[calc(100vh_-_58px)]" style={{ backgroundImage: `linear-gradient(120deg, #fb0008b5, #4382ffb4), url(${image})`, backgroundPosition: "center", backgroundRepeat: "no-repeat" }}>
      <div>
      ...
      <div className="drop-animation-banner">
        <p className="text-white text-4xl md:text-5xl font-brooklyn font-black">{title}</p>
