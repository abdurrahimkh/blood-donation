        ...
        <div class="about">
          ...
          <div class="row">
            <div class="about-col rounded-xl">
              ...
              <p className="text-sm">We connect blood donors with recipients, without any intermediary such as blood banks, for an efficient and seamless process.</p>
            </div>
            <div class="about-col">
              <div class="image">
